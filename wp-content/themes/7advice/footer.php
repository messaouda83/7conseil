<?php wp_footer(); ?>
  ...
  <!-- Footer Links -->
  <div style="background-color:#182333;">
  <div class="container text-center text-white text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <!-- Grid column -->
      <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 link">
      ...
      <!-- Grid column -->
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 link">

        <!-- Links -->
        <h6 class="">Contact</h6>
        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
        <p>
          <i class="fas fa-home mr-3"></i>  7 Rue des Buttes, 71380 Oslon</p>
        <p>
          <i class="fas fa-envelope mr-3"></i>contact@7conseil.fr</p>
        <p>
          <i class="fas fa-phone mr-3"></i>09 73 12 61 16</p>
